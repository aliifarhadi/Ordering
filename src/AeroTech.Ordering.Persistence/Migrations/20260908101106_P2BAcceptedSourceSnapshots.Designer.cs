            ...
            modelBuilder.Entity("AeroTech.Ordering.Domain.OrderAggregate.Entities.OrderItemCommercialTermsSnapshot", b =>
                {
                    ...
                    b.Property<string>("SourceRuleReference")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
            ...
            modelBuilder.Entity("AeroTech.Ordering.Domain.OrderAggregate.Entities.OrderItemCommercialTermsSnapshot", b =>
                {
                    ...
                    b.OwnsOne("AeroTech.Ordering.Domain.OrderAggregate.ValueObjects.Baggage", "CabinBaggage", b1 =>
                        {
                            b1.Property<long>("OrderItemCommercialTermsSnapshotId")
                                .HasColumnType("bigint");
                            ...
                            b1.HasKey("OrderItemCommercialTermsSnapshotId");

                            b1.ToTable("OrderItemCommercialTermsSnapshots", "Order");

                            b1.WithOwner()
                                .HasForeignKey("OrderItemCommercialTermsSnapshotId");
                        });

                    b.OwnsOne("AeroTech.Ordering.Domain.OrderAggregate.ValueObjects.Baggage", "CheckedBaggage", b1 =>
                        {
                            b1.Property<long>("OrderItemCommercialTermsSnapshotId")
                                .HasColumnType("bigint");
